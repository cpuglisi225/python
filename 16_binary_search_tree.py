...
class BST:
    ...
    def __inOrderRicorsivo(self, nodo, elementi):
        ...
        # CASO RICORSIVO:
        # 1visita prima tutto il sottoalbero sinistro (valori minori)
        self.__inOrderRicorsivo(nodo.left, elementi)

        # 2poi aggiungi il valore del nodo corrente
        elementi.append(nodo.valore)

        # 3poi visita tutto il sottoalbero destro (valori maggiori)
